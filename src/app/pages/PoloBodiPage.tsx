...
import sportSetImage from 'figma:asset/6ae769e9a0329163954f843935b952814f8fccb8.png';
...
const translations = {
  ua: {
    ...
    cart: 'Кошик',
    addToCart: 'В КОШИК',
    productName: 'ПОЛО-БОДІ',
    colorLabel: 'Колір',
    colorWhite: 'Білий',
    colorBlack: 'Чорний',
    colorBlue: 'Блакитний',
    descriptionParagraph: 'Поло-боді із щільною посадкою по тілу та асиметричною контрастною вставкою збоку — деталь, яка перетворює базовий виріб на самодостатній елемент образу. Подвійний комір-поло з ґудзиками додає структуру, асиметрична вставка — характер. Боді-крій із застібкою знизу забезпечує акуратний вигляд протягом усього дня та ідеальну посадку. Доступне у трьох кольорах: молочний, темно-синій та блакитний.',
    descriptionFeatures: [
      'Облягаючий крій',
      'Подвійний комір-поло з ґудзиками',
      'Асиметрична контрастна вставка',
      'Застібка-кнопки знизу',
    ],
    ...
    compositionContent: '95% бавовна, 5% еластан. Рекомендується ручне прання або делікатний режим.',
    completeLook: 'ЗАВЕРШІТЬ ОБРАЗ',
    sportSetName: 'Спортивний костюм',
    sportSetPrice: '9 500 ₴',
  },
  en: {
    collection: 'PREMIÈRE',
    ...
    productName: 'POLO BODYSUIT',
    colorLabel: 'Color',
    colorWhite: 'White',
    colorBlack: 'Black',
    colorBlue: 'Light Blue',
    descriptionParagraph: 'Fitted polo body with a body-hugging cut and asymmetric contrast panel on the side — a detail that transforms a basic piece into a statement. Double polo collar with buttons adds structure, the asymmetric panel adds character. Snap closure at the bottom ensures a neat look all day. Available in three colors: ivory, navy and light blue.',
    descriptionFeatures: [
      'Fitted cut',
      'Double polo collar with buttons',
    ...
    compositionContent: '95% cotton, 5% elastane. Hand wash or delicate cycle recommended.',
    completeLook: 'COMPLETE THE LOOK',
    sportSetName: 'Sport Set',
    sportSetPrice: '9 500 ₴',
  },
  pl: {
    collection: 'PREMIÈRE',
    ...
    productName: 'BODY POLO',
    colorLabel: 'Kolor',
    colorWhite: 'Biały',
    colorBlack: 'Czarny',
    colorBlue: 'Jasnoniebieski',
    descriptionParagraph: 'Dopasowane body polo z asymetryczną kontrastową wstawką z boku — detal, który zamienia podstawowy element w samodzielny akcent stylizacji. Podwójny kołnierzyk polo z guzikami dodaje struktury. Krój body z zatrzaskami na dole. Dostępne w trzech kolorach: ecru, granatowy i błękitny.',
    descriptionFeatures: [
      'Dopasowany krój',
      'Podwójny kołnierzyk polo z guzikami',
      'Asymetryczna kontrastowa wstawka',
      'Zatrzaski na dole',
    ],
    ...
    compositionContent: '95% bawełna, 5% elastan. Zalecane pranie ręczne lub w trybie delikatnym.',
    completeLook: 'UZUPEŁNIJ LOOK',
    sportSetName: 'Zestaw sportowy',
    sportSetPrice: '9 500 ₴',
  },
};
      ...
      <section className="py-16 px-8 bg-white">
        <div className="max-w-screen-2xl mx-auto">
          ...
          <div className="flex justify-center">
            <button 
              onClick={() => navigate('/product/sport-set')}
