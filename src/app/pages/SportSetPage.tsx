...
import productImage from 'figma:asset/b003d9fb485233a3a1674b2ae3491c22c4ece92e.png';
...
const translations = {
  ua: {
    ...
    colorNavy: 'Navy',
    colorCream: 'Молочний',
    descriptionParagraph: "Комплект із зіп-худі та балон-спідниці, в якому спортивний силует набуває виразного характеру завдяки контрастним смугам по крою. Об'ємна спідниця на еластичному поясі формує м'який повітряний силует — між спортом і стилем. Доступний у двох кольорах: темно-синій з білими вставками та молочний з темно-синім акцентом. Продається лише комплектом.",
    descriptionFeatures: [
      'Зіп-худі на блискавці',
      'Балон-спідниця з еластичним поясом',
      'Кольори: темно-синій / молочний',
    ],
  ...
  en: {
    ...
    colorNavy: 'Navy',
    colorCream: 'Ivory',
    descriptionParagraph: 'A zip hoodie and balloon skirt set where the sporty silhouette gains expressive character through contrast stripes. Available in two colors: navy with white inserts and ivory with navy accent. Sold as a set only.',
    descriptionFeatures: [
      'Zip hoodie',
  ...
  pl: {
    ...
    colorNavy: 'Navy',
    colorCream: 'Kremowy',
    descriptionParagraph: 'Komplet z bluzą na zamek i spódnicą balonem. Dostępny w dwóch kolorach: granatowy z białymi wstawkami i ecru z granatowym akcentem. Sprzedawany tylko jako komplet.',
    descriptionFeatures: [
      'Bluza na zamek',
      'Spódnica balon z elastycznym pasem',
      'Kolory: granatowy / ecru',
    ],
...
export default function SportSetPage() {
  ...
  const [selectedColor, setSelectedColor] = useState('#1A2744');
  ...
  const colors = [
    { value: '#1A2744', label: 'Navy' },
    { value: '#F5F0EB', label: 'Cream' },
  ];
        ...
        <div className="max-w-screen-2xl mx-auto">
          ...
          <div className="flex justify-center gap-8">
            {selectedColor === '#1A2744' ? (
              // Navy sport set: show navy + white polo cards
              <>
                <button 
                ...
                >
                  <div className="relative aspect-[3/4] overflow-hidden w-48">
                    <div className="w-full h-full flex items-center justify-center" style={{ backgroundColor: '#1A2744' }}>
                      <div className="w-16 h-16 rounded-full" style={{ backgroundColor: '#1A2744', border: '2px solid white' }}></div>
                    </div>
                ...
                >
                  <div className="relative aspect-[3/4] overflow-hidden w-48">
                    <div className="w-full h-full flex items-center justify-center" style={{ backgroundColor: '#FAFAFA' }}>
                      <div className="w-16 h-16 rounded-full" style={{ backgroundColor: '#FAFAFA', border: '2px solid #1A2744' }}></div>
                    </div>
                    <div className="absolute inset-0 bg-black/20 group-hover:bg-black/30 transition flex items-center justify-center">
                      <div className="w-12 h-12 rounded-full bg-white/90 flex items-center justify-center">
                        <Plus className="w-6 h-6" style={{ color: '#1A2744' }} />
              ...
              // Ivory/cream sport set: show light blue + white polo cards
              <>
                <button 
                  onClick={() => navigate('/product/polo-bodi')}
                  className="relative group max-w-xs"
                >
                  <div className="relative aspect-[3/4] overflow-hidden w-48">
                    <div className="w-full h-full flex items-center justify-center" style={{ backgroundColor: '#AEE2FC' }}>
                      <div className="w-16 h-16 rounded-full" style={{ backgroundColor: '#AEE2FC', border: '2px solid #1A2744' }}></div>
                    </div>
                    <div className="absolute inset-0 bg-black/20 group-hover:bg-black/30 transition flex items-center justify-center">
                      <div className="w-12 h-12 rounded-full bg-white/90 flex items-center justify-center">
                        <Plus className="w-6 h-6" style={{ color: '#1A2744' }} />
