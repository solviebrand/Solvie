...
import blackDressImage1 from 'figma:asset/e9ba97433f9a31efcf9ac58e0ba23b847048d6cb.png';
import blackDressImage2 from 'figma:asset/83f4eae441f94362cdca68ab163c4e03dd67af85.png';
import blackDressImage3 from 'figma:asset/454bdba1950799add83f99f31ee3f01c70a2dad1.png';
import blackDressImage4 from 'figma:asset/6c00cd83bd2986406a280ce82989a8d7b3c92921.png';
import capeImage from 'figma:asset/f8dd7a5a7adf4c11672ccc68de1431c698490972.png';
...
const translations = {
  ua: {
    ...
    colorLabel: 'Колір',
    colorBlack: 'Чорний',
    descriptionParagraph: 'Лаконічна міні-сукня з корсетним верхом на широких бретелях і бічними вставками, що підкреслюють природну форму тіла. Чіткий приталений силует балансує між стриманістю та виразністю. Поєднується з гостроносими туфлями, масивними прикрасами або відкритим жакетом поверх.',
    descriptionFeatures: [
      'Широкі бретелі',
      'Корсетний верх',
      'Бічні вставки по фігурі',
      'Колір: чорний',
    ],
  ...
  en: {
    ...
    colorLabel: 'Color',
    colorBlack: 'Black',
    descriptionParagraph: 'A minimal mini dress with a corset top on wide straps and side panels that emphasize the natural shape of the body. Pairs with pointed heels, statement jewelry or an open jacket on top.',
    descriptionFeatures: [
      'Wide straps',
      'Corset top',
      'Side panels',
  ...
  pl: {
    ...
    colorLabel: 'Kolor',
    colorBlack: 'Czarny',
    descriptionParagraph: 'Minimalistyczna mini sukienka z gorsetową górą na szerokich ramiączkach i bocznymi wstawkami.',
    descriptionFeatures: [
      'Szerokie ramiączka',
      'Gorsetowa góra',
      'Boczne wstawki',
...
export default function DressBlackPage() {
  ...
  const galleryImages = [blackDressImage1, blackDressImage2, blackDressImage3, blackDressImage4];
