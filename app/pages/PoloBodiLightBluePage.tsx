...
import poloBlueImage1 from 'figma:asset/6add0dab2764f7702d323e6ed603ed8900256a28.png';
import poloBlueImage2 from 'figma:asset/bd80483e23c3654a9f15812e0c5999cf3271c656.png';
import poloBlueImage3 from 'figma:asset/f9dff832c0d7af6d28d7f0b0f60a239d12bf6ce5.png';
import poloBlueImage4 from 'figma:asset/ce9fcaf0e1e8da8aea86db2a67621cf335a0a1c5.png';
...
const translations = {
  UA: {
    ...
    cart: 'Кошик',
    addToCart: 'В КОШИК',
    productName: 'ПОЛО-БОДІ — БЛАКИТНЕ',
    colorLabel: 'Колір',
  ...
  EN: {
    ...
    productName: 'POLO BODYSUIT — LIGHT BLUE',
    colorLabel: 'Color',
    colorLightBlue: 'Light Blue',
    descriptionParagraph: 'Delicate light blue polo bodysuit with classic collar and comfortable fit. Premium fabric ensures all-day comfort. Perfect wardrobe staple for creating versatile looks.',
    descriptionFeatures: [
      'Classic polo collar',
      'Comfortable bodysuit design with snap closure',
      'Premium light blue fabric',
  ...
  PL: {
    ...
    productName: 'POLO BODY — BŁĘKITNE',
    colorLabel: 'Kolor',
    colorLightBlue: 'Błękitny',
    descriptionParagraph: 'Delikatne polo body w błękitnym kolorze z klasycznym kołnierzykiem i wygodnym krojem. Tkanina premium zapewnia komfort przez cały dzień. Idealny element garderoby do tworzenia uniwersalnych stylizacji.',
    descriptionFeatures: [
      'Klasyczny kołnierzyk polo',
      'Wygodny krój body z zapięciem na zatrzaski',
      'Tkanina premium w błękitnym kolorze',
...
export default function PoloBodiLightBluePage() {
  ...
  const galleryImages = [poloBlueImage1, poloBlueImage2, poloBlueImage3, poloBlueImage4];
  ...
  const productData: Product = {
    id: 1,
    name: {
      UA: 'ПОЛО-БОДІ — БЛАКИТНЕ',
      EN: 'POLO BODYSUIT — LIGHT BLUE',
      PL: 'POLO BODY — BŁĘKITNE'
    },
  ...
  const handleAddToCart = () => {
    addToCart(productData, selectedSize, 'Light Blue');
    setIsCartOpen(true);
  };
              ...
              <div className="mb-6">
                ...
                <ColorSwitcher
                  variants={[
                    ...
                    { color: 'Блакитний', colorHex: '#AEE2FC', path: '/product/polo-bodi-light-blue', isActive: true },
                  ]}
                  currentColorName={t.colorLightBlue}
                />
              </div>
