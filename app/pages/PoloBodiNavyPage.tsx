...
import poloNavyImage1 from 'figma:asset/685287a57238df036e6d220a68886727aedebfce.png';
...
const translations = {
  UA: {
    ...
    cart: 'Кошик',
    addToCart: 'В КОШИК',
    productName: 'ПОЛО-БОДІ — ТЕМНО-СИНЄ',
    colorLabel: 'Колір',
    colorNavy: 'Темно-синє',
    colorWhite: 'Білий',
    colorLightBlue: 'Блакитний',
  ...
  EN: {
    ...
    productName: 'POLO BODYSUIT — NAVY BLUE',
    colorLabel: 'Color',
    colorNavy: 'Navy Blue',
    colorWhite: 'White',
    colorLightBlue: 'Light Blue',
    descriptionParagraph: 'Elegant navy polo bodysuit with contrasting white panel and double collar. Premium fabric and thoughtful design create a refined silhouette. Perfect wardrobe staple for creating stylish looks.',
    descriptionFeatures: [
      'Double collar with contrasting white panel',
      'Comfortable bodysuit design with snap closure',
      'Asymmetric contrast panel',
      'Premium navy fabric',
  ...
  PL: {
    ...
    productName: 'POLO BODY — NAVY',
    colorLabel: 'Kolor',
    colorNavy: 'Granatowy',
    colorWhite: 'Biały',
    colorLightBlue: 'Jasny niebieski',
    descriptionParagraph: 'Eleganckie polo body w kolorze navy z kontrastowym białym panelem i podwójnym kołnierzykiem. Tkanina premium i przemyślany krój tworzą wyrafinowaną sylwetkę. Idealny element garderoby do tworzenia stylowych stylizacji.',
    descriptionFeatures: [
      'Podwójny kołnierzyk z kontrastowym białym panelem',
      'Wygodny krój body z zapięciem na zatrzaski',
      'Asymetryczny panel kontrastowy',
      'Tkanina premium w kolorze navy',
...
export default function PoloBodiNavyPage() {
  ...
  const galleryImages = [poloNavyImage1];

  const t = translations[language];
  const currency = language === 'PL' ? 'zł' : '₴';
  const price = language === 'PL' ? '400' : '4 900';
  ...
  const productData: Product = {
    ...
    name: {
      UA: 'ПОЛО-БОДІ — NAVY',
      EN: 'POLO BODYSUIT — NAVY',
      PL: 'POLO BODY — NAVY'
    },
    price: { uah: 4900, pln: 400 },
    description: {
      UA: 'Елегантне поло-боді темно-синього кольору з контрастною білою вставкою та подвійним коміром. Преміальна тканина та продуманий крій створюють витончений силует. Ідеально підходить як базовий елемент гардеробу для створення стильних образів.',
      EN: 'Elegant navy polo bodysuit with contrasting white panel and double collar. Premium fabric and thoughtful design create a refined silhouette. Perfect wardrobe staple for creating stylish looks.',
      PL: 'Eleganckie polo body w kolorze navy z kontrastowym białym panelem i podwójnym kołnierzykiem. Tkanina premium i przemyślany krój tworzą wyrafinowaną sylwetkę. Idealny element garderoby do tworzenia stylowych stylizacji.'
    },
    features: {
      UA: [
        'Подвійний комірець з контрастною білою вставкою',
    ...
    returns: {
      UA: 'Ви можете повернути товар протягом 14 днів з моменту отримання. Товар має бути в оригінальній упаковці з бирками.',
      EN: 'You can return the item within 14 days of receipt. Item must be in original packaging with tags.',
      PL: 'Możesz zwrócić towar w ciągu 14 dni od otrzymania. Towar musi być w oryginalnym opakowaniu z metkami.'
    },
    composition: {
      UA: 'Преміальний трикотаж з додаванням еластану для комфорту',
      EN: 'Premium knitwear with elastane for comfort',
      PL: 'Dzianina premium z dodatkiem elastanu dla komfortu'
    },
    colors: ['Navy']
  };

  const handleAddToCart = () => {
    addToCart(productData, selectedSize, 'Navy');
    setIsCartOpen(true);
  };
          ...
          <div className="bg-white px-12 py-16">
            <div className="max-w-md">
              ...
              <div className="mb-6">
                ...
                <ColorSwitcher
                  variants={[
                    { color: 'Білий', colorHex: '#FAFAFA', path: '/product/polo-bodi', isActive: false },
                    { color: 'Темно-синій', colorHex: '#1A2744', path: '/product/polo-bodi-navy', isActive: true },
                    { color: 'Блакитний', colorHex: '#AEE2FC', path: '/product/polo-bodi-light-blue', isActive: false },
                  ]}
                  currentColorName={t.colorNavy}
                />
              </div>
