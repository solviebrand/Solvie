...
import poloNavyImage from 'figma:asset/685287a57238df036e6d220a68886727aedebfce.png';
...
const translations = {
  UA: {
    ...
    productName: 'СПОРТИВНИЙ КОСТЮМ — ТЕМНО-СИНІЙ',
    colorLabel: 'Колір',
    colorNavy: 'Темно-синій',
    descriptionParagraph: 'Елегантний спортивний костюм темно-синього кольору з білими контрастними акцентами. Комплект складається з укороченої зіп-худі зі структурованими плечима та пишної спідниці-балон. Ідеальне поєднання комфорту та стилю для будь-якого випадку.',
    descriptionFeatures: [
      'Укорочена зіп-худі з контрастною обробкою',
      'Пишна спідниця-балон',
      'Структуровані плечі з білими акцентами',
      'Преміальна тканина',
      'Темно-синій колір з білими акцентами',
    ],
  ...
  EN: {
    ...
    colorLabel: 'Color',
    colorNavy: 'Navy',
    descriptionParagraph: 'Elegant navy sport set with white contrast accents. The set consists of a cropped zip hoodie with structured shoulders and a voluminous balloon skirt. Perfect combination of comfort and style for any occasion.',
    descriptionFeatures: [
      'Cropped zip hoodie with contrast trim',
      'Voluminous balloon skirt',
      'Structured shoulders with white accents',
      'Premium fabric',
      'Navy color with white accents',
    ],
  ...
  PL: {
    ...
    colorLabel: 'Kolor',
    colorNavy: 'Navy',
    descriptionParagraph: 'Elegancki zestaw sportowy w kolorze navy z białymi akcentami kontrastowymi. Komplet składa się z krótkiej bluzy z zamkiem i strukturalnymi ramionami oraz puszystej spódnicy balonowej. Idealne połączenie komfortu i stylu.',
    descriptionFeatures: [
      'Krótka bluza z zamkiem i kontrastowym wykończeniem',
      'Puszczysta spódnica balonowa',
      'Strukturalne ramiona z białymi akcentami',
      'Tkanina premium',
      'Kolor navy z białymi akcentami',
    ],
      ...
      <section className="py-16 px-8 bg-white">
        <div className="max-w-screen-2xl mx-auto">
          ...
          <div className="flex justify-center gap-8">
            {/* Polo-Bodi Navy */}
            <button
              onClick={() => navigate('/product/polo-bodi-navy')}
              className="relative group max-w-xs"
            >
              <div className="relative aspect-[3/4] overflow-hidden w-48">
                <img src={poloNavyImage} alt="Поло-боді Темно-синє" className="w-full h-full object-cover" />
