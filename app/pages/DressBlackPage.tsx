...
import dressImage1 from 'figma:asset/e9ba97433f9a31efcf9ac58e0ba23b847048d6cb.png';
import dressImage2 from 'figma:asset/83f4eae441f94362cdca68ab163c4e03dd67af85.png';
import dressImage3 from 'figma:asset/454bdba1950799add83f99f31ee3f01c70a2dad1.png';
import dressImage4 from 'figma:asset/6c00cd83bd2986406a280ce82989a8d7b3c92921.png';
import logoImage from 'figma:asset/9f47ea753513e9aeaf96960b681715cbd4d9f754.png';
import capeBlackImage from 'figma:asset/04b50abfa162670800fa00dbafbbc39b2108a9bd.png';
...
const translations = {
  ua: {
    ...
    productName: 'СУКНЯ — ЧОРНА',
    colorLabel: 'Колір',
    colorBlack: 'Чорний',
    descriptionParagraph: 'Елегантна міні-сукня чорного кольору із короткою накидкою-кейпом. Вирізана ділянка біля декольте надає образу сучасності та жіночності. Ідеальний варіант для будь-якої події — від офісу до вечірньої зустрічі.',
    descriptionFeatures: [
      'Міні-сукня чорного кольору',
  ...
  en: {
    ...
    colorLabel: 'Color',
    colorBlack: 'Black',
    descriptionParagraph: 'Elegant black mini dress with a short cape overlay. The cutout detail at the neckline adds a modern and feminine touch. Perfect for any occasion — from the office to evening events.',
    descriptionFeatures: [
      'Black mini dress',
      'Short cape included',
  ...
  pl: {
    ...
    total: 'Razem',
    checkout: 'Zamówienie',
    productName: 'SUKIENKA — CZARNA',
    colorLabel: 'Kolor',
    colorBlack: 'Czarny',
    descriptionParagraph: 'Elegancka czarna mini sukienka z krótką peleryną. Wycięcie przy dekolcie dodaje nowoczesności i kobiecości. Idealny wybór na każdą okazję.',
    descriptionFeatures: [
...
export default function DressBlackPage() {
  ...
  const product = {
    ...
    image: dressImage1,
    galleryImages: [dressImage2, dressImage3, dressImage4],
    description: {
      ua: 'Елегантна міні-сукня чорного кольору',
      en: 'Elegant black mini dress',
      pl: 'Elegancka czarna mini sukienka',
    },
    colors: ['#0D0D0D'],
  };

  const handleAddToCart = () => {
    addToCart(product, selectedSize, t.colorBlack);
    setIsCartOpen(true);
  };
          ...
          <div className="bg-white px-12 py-16">
            <div className="max-w-md">
              ...
              <div className="mb-6">
                ...
                <ColorSwitcher
                  variants={[
                    { color: 'Білий', colorHex: '#FAFAFA', path: '/product/dress-ivory', isActive: false },
                    { color: 'Чорний', colorHex: '#0D0D0D', path: '/product/dress-black', isActive: true },
                  ]}
      ...
      <section className="py-16 px-8 bg-white">
        <div className="max-w-screen-2xl mx-auto">
          ...
          <div className="flex justify-center">
            {/* Cape Black */}
            <button
              onClick={() => navigate('/product/cape')}
              className="relative group max-w-xs"
            >
              <div className="relative aspect-[3/4] overflow-hidden w-48">
                <img src={capeBlackImage} alt="Кейп Чорний" className="w-full h-full object-cover" />
