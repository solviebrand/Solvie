...
import capeImage1 from 'figma:asset/dbdc0ec850c86b5aa35ce7175173fbf4da4b0599.png';
import capeImage2 from 'figma:asset/76bab8dc1fe508715c5ead74939d573b8676c435.png';
import capeImage3 from 'figma:asset/28a621afb9998a311c56ba545ed7c9ad644c700e.png';
import capeImage4 from 'figma:asset/bbf0169186475ebaaa77b3eca46f60b8b60316cc.png';
...
const translations = {
  ua: {
    ...
    cart: 'Кошик',
    addToCart: 'В КОШИК',
    productName: 'КЕЙП — БІЛИЙ',
    colorLabel: 'Колір',
    colorWhite: 'Білий',
    descriptionParagraph: 'Елегантний кейп білого кольору — ідеальне доповнення до вечірнього образу. Додає витонченості та елегантності будь-якому вбранню. Створений із преміальної тканини.',
    descriptionFeatures: [
      'Білий кейп-накидка',
      'Подовжені рукави',
  ...
  en: {
    ...
    productName: 'CAPE — WHITE',
    colorLabel: 'Color',
    colorWhite: 'White',
    descriptionParagraph: 'Elegant white cape — the perfect complement to an evening look. Adds sophistication and elegance to any outfit. Made from premium fabric.',
    descriptionFeatures: [
      'White cape overlay',
      'Extended sleeves',
  ...
  pl: {
    ...
    productName: 'PELERYNA — BIAŁA',
    colorLabel: 'Kolor',
    colorWhite: 'Biały',
    descriptionParagraph: 'Elegancka biała peleryna — idealne uzupełnienie wieczorowej stylizacji. Dodaje wyrafinowania i elegancji każdemu ubraniu. Wykonana z tkaniny premium.',
    descriptionFeatures: [
      'Biała peleryna',
      'Wydłużone rękawy',
...
export default function CapeWhitePage() {
          ...
          <div className="bg-white px-12 py-16">
            <div className="max-w-md">
              ...
              <div className="mb-6">
                ...
                <ColorSwitcher
                  variants={[
                    { color: 'Білий', colorHex: '#FAFAFA', path: '/product/cape-white', isActive: true },
                    { color: 'Чорний', colorHex: '#0D0D0D', path: '/product/cape', isActive: false },
                  ]}
                  currentColorName={t.colorWhite}
                />
              </div>
